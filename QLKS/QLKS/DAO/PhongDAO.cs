...
namespace QLKS.DAO
{
    public class PhongDAO
    {
        ...
        {
            string query = string.Format("INSERT INTO phong (IDPhong, ThoiGianBatDau, IDKhachHang, DsDichVu) VALUES('{0}','{1}','{2}','{3}')", _phong.IdPhong, _phong.ThoiGianBatDau, _phong.IdKhachHang, _phong.DsDichVu);
            return DBConnection.getInstance().Insert(query) ? true : false;
        }
